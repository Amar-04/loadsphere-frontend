...
export default function DashboardLayout({
  ...
  const menuItems = [
    ...
    { label: "User Management", icon: BookCheck, href: "/admin/user-management" },
    {
      label: "User verification",
      icon: PackageOpen,
      href: "/admin/user-verification",
    },
    { label: "Deliveries", icon: LayoutDashboard, href: "/admin/deliveries" },
  ];
  ...
  return (
    <div className="min-h-screen flex transition-all duration-300">
      ...
      >
        <div>
          ...
          <div className="flex flex-col gap-6 text-xl border-b-3 pb-4">
            ...
            <div className="relative mx-6 mt-4">
              ...
              {/* Notification dot */}
              <span className="absolute top-0 left-5 w-2 h-2 bg-loadPurple rounded-full" />
            </div>
        ...
        {/* Logout */}
        <div className="border-t-2 border-loadPurple p-2 flex cursor-pointer items-center">
          <div className="text-loadPurple border-r-2 border-loadPurple pr-2">
            <LogOut />
          </div>
        ...
        <div className="flex justify-between p-6 items-center">
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="text-loadPurple text-xl focus:outline-none cursor-pointer"
            >
              {isSidebarOpen ? "❮" : "❯"}
            </button>
            {/* Page Title */}
