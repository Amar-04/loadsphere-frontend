    ...
    <div className="flex flex-col p-6">
      <div className="w-full border-b border-white mx-6">
        <div className="flex justify-between font-bold w-[40%]">
          <Button className="bg-transparent rounded-md text-white text-lg hover:bg-loadBlue">
            Confirmed
          </Button>
          <Button className="bg-transparent rounded-md text-white text-lg hover:bg-loadBlue">
            Pending
      ...
      <div className="rounded-xl overflow-hidden p-4">
        ...
        {confirmedLoads.map((load, index) => (
          ...
          >
            ...
            <Button className="text-[#3498db] bg-transparent hover:bg-transparent cursor-pointer">
              <ArrowRight size={18} />
            </Button>
          </div>
        ))}
            ...
            <div className="flex justify-between">
              <div>
                <p className="text-muted-foreground text-sm">
                  Load{" "}
                  <span className="text-blue-500 font-medium">#753805368</span>
                </p>
