...
export default function DashboardLayout({
  ...
  const menuItems = [
    { label: "Dashboard", icon: LayoutDashboard, href: "/carrier/dashboard" },
    { label: "My Bookings", icon: BookCheck, href: "/carrier/my-bookings" },
    { label: "Load Discovery", icon: PackageOpen, href: "/carrier/load-discovery" },
    {
      label: "Fleet Management",
      icon: Truck,
      href: "/carrier/fleet",
      children: [
        { label: "Truck Availability", href: "/carrier/fleet/truck-availability" },
        { label: "Track Fleet Location", href: "/carrier/fleet/track-fleet" },
        { label: "Manage Equipment", href: "/carrier/fleet/manage-equipment" },
      ],
    },
    {
      ...
      children: [
        {
          ...
          href: "/carrier/documents/letter-of-completion",
        },
        { label: "Driver Documents", href: "/carrier/documents/driver-documents" },
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen flex transition-all duration-300">
      ...
      >
        <div>
          ...
          <div className="flex flex-col gap-6 text-xl border-b-3 pb-4">
            ...
            <div className="relative mx-6 mt-4">
              ...
              {/* Notification dot */}
              <span className="absolute top-0 left-5 w-2 h-2 bg-loadBlue rounded-full" />
            </div>
        ...
        {/* Logout */}
        <div className="border-t-2 border-loadBlue p-2 flex cursor-pointer items-center">
        ...
        <div className="flex justify-between p-6 items-center">
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="text-loadBlue text-xl focus:outline-none cursor-pointer"
            >
              {isSidebarOpen ? "❮" : "❯"}
            </button>
            {/* Page Title */}
