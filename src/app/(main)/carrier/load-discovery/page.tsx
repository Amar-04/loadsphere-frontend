  ...
  return (
    <div className="min-h-screen container">
      ...
      <div className="px-6 py-1 rounded-md dark:text-white space-y-4">
        <h2 className="text-4xl font-bold">Find Loads</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-loadBlue/90 font-medium text-xl">
              Type of Load :
            </span>
            <Button className="bg-loadLightBlue dark:bg-loadGray dark:text-white hover:bg-loadBlue/90 px-4 py-1 h-auto rounded-md text-sm cursor-pointer">
              FTL
            </Button>
            <Button className="bg-loadLightBlue dark:bg-loadGray hover:bg-loadBlue/90 dark:text-white px-4 py-1 h-auto rounded-md text-sm cursor-pointer">
              LTL
            </Button>
          </div>
      ...
      <div className="flex flex-col px-6 py-2">
        <h1 className="dark:text-white text-3xl font-bold">Load Listing:</h1>
        <div className="grid grid-cols-3 gap-1">
          {/* left  */}
          <div className="flex flex-col col-span-2">
            <Card className="relative bg-[#01629F] border-none rounded-xs mt-2 px-4 py-1">
              {/* Status indicator */}
              ...
              <div className="flex flex-col">
                ...
                <div className="flex justify-between mt-2">
                  <div className="flex gap-1 items-center">
                    ...
                    <p className="text-sm text-gray-200">1 pick, 1 drop</p>
                  </div>
                  ...
                  <div className="flex gap-1 items-center">
                    ...
                    <p className="text-sm text-yellow-500">Book or Offer</p>
                  </div>
                </div>
              </div>
            </Card>

            <Card className="relative bg-[#013C61] border-none rounded-xs mt-3  px-4 py-1">
              <div className="flex flex-col">
                <div className="w-[92%] bg-loadGray border flex items-center justify-between rounded-sm">
                  <div className="flex flex-col p-2">
                    <h3 className="font-semibold text-white">
          ...
          <div className="flex flex-col max-h-[90%] bg-loadLightBlue dark:bg-loadGray m-4 border rounded-md">
              ...
              <div className="flex p-4 relative">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-blue-500 font-medium">PICKUP</p>
            ...
            <div className="flex space-x-2 p-4">
              <Button className="text-white bg-loadBlue hover:bg-loadBlue/90 w-1/2 py-4">
                Book (1,550.00 USD)
              </Button>
