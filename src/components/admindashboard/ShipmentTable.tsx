...
const ShipmentTable = () => {
  return (
    <div>
      <h3 className="text-lg font-medium mb-4">Recent Delivery Status</h3>
      <div className="bg-loadLightBlue dark:bg-loadGray rounded-xl overflow-hidden p-4">
        <div className="grid grid-cols-5 gap-4 p-2 text-loadPurple">
          <div>Load No.</div>
        ...
        {[1, 2, 3, 4].map((item, index) => (
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="#" className="text-loadPurple">
                <ArrowRight size={18} />
              </Link>
            </div>
          </div>
