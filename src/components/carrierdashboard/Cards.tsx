    ...
    <div className="grid grid-cols-3 gap-8 my-4">
      <Card className="bg-loadLightBlue dark:bg-loadGray dark:text-white rounded-4xl border-none">
        <CardContent className="flex flex-col space-y-4">
          ...
          <div className="flex">
            ...
            <p className="text-loadBlue mt-6 ml-2 font-bold">Hours</p>
          </div>
      ...
      <Card className="bg-loadLightBlue dark:bg-loadGray dark:text-white rounded-4xl border-none">
        <CardContent className="flex flex-col space-y-4">
          ...
          <div className="flex">
            ...
            <p className="text-loadBlue mt-6 ml-2 font-bold">Ctnr</p>
          </div>
          <p className="text-gray-400">April to Sept.</p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-loadLightBlue dark:bg-loadGray dark:text-white rounded-4xl border-none">
        <CardContent className="flex flex-col space-y-4">
          ...
          <div className="flex">
            ...
            <p className="text-loadBlue mt-6 ml-2 font-bold">Kms</p>
          </div>
          <p className="text-gray-400">April to Sept.</p>
        </CardContent>
      </Card>
      ...
      <Card className="rounded-4xl bg-loadLightBlue dark:bg-loadGray dark:text-white border-none">
        ...
        <div className="flex items-center justify-between border-t border-gray-600 px-6 py-2">
          <Button className="bg-white dark:bg-loadDarkGray p-6 rounded-xl text-loadBlue hover:bg-loadBlue text-sm font-medium">
            Month
          </Button>
          <Button className="bg-white dark:bg-loadDarkGray p-6 rounded-xl text-black hover:bg-loadBlue dark:text-white text-sm font-medium">
            April -- September
          </Button>
        </div>
      </Card>
